...
![HP ProDesk Gehäuse](images/01_hp_prodesk_gehaeuse.jpeg)

## Einbau

Gehäuse geöffnet, direkt neben den SATA-Anschlüssen war ein freier M.2-Slot auf dem Mainboard.

![Mainboard geöffnet](images/02_mainboard_geoeffnet.jpeg)

Neue Samsung NVMe SSD (1TB) eingesetzt.

![Neue SSD in der Hand](images/03_neue_m2_ssd_in_der_hand.jpeg)

![SSD eingebaut](images/04_ssd_eingebaut.jpeg)

Gehäuse wieder zusammengebaut.

![Gehäuse Zusammenbau](images/05_gehaeuse_zusammenbau.jpeg)
...
![BootDevice Not Found](images/06_bootdevice_not_found.jpeg)
...
![Rufus ISO kopieren](images/07_rufus_iso_kopieren.jpeg)
...
![Spracheinstellungen](images/09_spracheinstellungen.jpeg)
...
![Windows Setup Partitionsauswahl](images/08_windows_setup_partitionsauswahl.jpeg)
...
![Windows Update](images/10_windows_update.jpeg)
